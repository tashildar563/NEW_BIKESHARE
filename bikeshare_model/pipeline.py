...
bikeshare_pipe = Pipeline([
    ...
    ###### Imputation ######
    ('weekday_imputaion',WeekdayImputer(variable = config.model_config.weekday_var,date_var = config.model_config.date_var)),
    ('weathersit_imputation', WeathersitImputer(variable = config.model_config.weathersit_var)),
    
    ('map_yr',Mapper(variable = config.model_config.yr_var, mapping = config.model_config.yr_mappings)),
    ('map_mnth',Mapper(variable = config.model_config.mnth_var,mapping=config.model_config.mnth_mappings)),
    ('map_season',Mapper(variable = config.model_config.season_var, mapping=config.model_config.season_mappings)),
    ('map_weathersit',Mapper(variable = config.model_config.weathersit_var, mapping= config.model_config.weathersit_mappings)),
    ('map_holiday',Mapper(variable = config.model_config.holiday_var, mapping = config.model_config.holiday_mappings)),
    ('map_workingday',Mapper(variable = config.model_config.workingday_var, mapping = config.model_config.workingday_mappings)),
    ('map_hr',Mapper(variable =config.model_config.hr_var, mapping = config.model_config.hr_mappings)),
